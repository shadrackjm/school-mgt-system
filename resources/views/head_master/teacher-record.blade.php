        ...
        <form id="teacherForm">
          ...
          <div class="form-group my-2">
            ...
            <select class="form-select" name="education_level">
              <option value="">Choose Eduction Level</option>
      ...
      <div class="modal-body">
        <form id="editTeacherForm">
          ...
          <div class="form-group my-2">
            ...
            <span class="text-danger" id="edit_education_level_error"></span>
          </div>
          <div class="form-group my-2">
...
$('.editButton').click(function(){
  ...
  $('#teacher_id').val(teacher_id);
       var url = '{{ route("GetTeacherDetails","teacher_id") }}';
           ...
           $.ajax({
               ...
               success:function(data){
                   if(data.success == true){
                       ...
                       $("#education_level").val(teacher_data[0].education_level);
