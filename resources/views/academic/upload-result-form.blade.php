...
<script>
        $(document).ready(function(){
            ...
            $("#term").on('change',function(){
                var term = $("#term").val();
                if(term == 'term1'){
                    var url = '{{ route("AcademicGetOptions","term") }}';
            ...
            // console.log(formData);
                        ...
                        $('#midterm1Form').submit(function(e){
                            ...
                            // console.log(formData);
                                            ...
                                            $.ajax({
                                url:"{{ route('Academicmidterm1Upload') }}",
                                data:formData,
                                type:"GET",
                                contentType: false,
                                processData:false,
                        ...
                        $('#midterm2Form').submit(function(e){
                            ...
                            // console.log(formData);
                                            ...
                                            $.ajax({
                                url:"{{ route('Academicmidterm2Upload') }}",
                                data:formData,
                                type:"GET",
                                contentType: false,
                                processData:false,
                        ...
                        $('#terminalForm').submit(function(e){
                            ...
                            // console.log(formData);
                                            ...
                                            $.ajax({
                                url:"{{ route('AcademicterminalUpload') }}",
                                data:formData,
                                type:"GET",
                                contentType: false,
                                processData:false,
                        ...
                        $('#annualForm').submit(function(e){
                            ...
                            var formData = $(this).serialize();
                            $.ajax({
                                url:"{{ route('AcademicannualUpload') }}",
                                data:formData,
                                type:"GET",
                                contentType: false,
                                processData:false,
