...
<span class="alert alert-success" id="alert-success" style="display:none;"></span>
  <div class="card">
    <div class="card-header">
        Student attendance 
        <a href="/attendance/review/{{$form_l}}/{{$stream_l}}" class="btn btn-outline-primary btn-sm mx-5">Today's Attendance</a>
    </div>
    <div class="card-body">
                ...
                <tr>
                    ...
                    <td>
                        <select name="attendance[]" class="form-select">
                            <option value="1" class="bg-success text-white">Present</option>
                            <option value="2" class="bg-danger text-white">Absent</option>
                        </select>
                    </td>
